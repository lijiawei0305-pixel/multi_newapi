...
/**
 * Original isometric "AI compute" hero illustration for the Agent Program page:
 * a layered server rack on an isometric platform, a floating gradient chip core
 * connected by a light beam, and distribution nodes fanning out over a network.
 *
 * Hand-authored original vector art (not derived from any third-party asset).
 * Tuned to read on both light (primary) and dark Hero backgrounds; scales via the
 * viewBox, colored with the project brand gradient (blue #3b82f6 -> violet #8b5cf6).
 */
