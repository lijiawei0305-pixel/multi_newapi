...
import { ReportPagination } from '@/features/financial-report/components/report-pagination'
...
export function MyWithdrawalsTable({
  items,
  loading,
  page,
  pageSize,
