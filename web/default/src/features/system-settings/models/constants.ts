...
export const OFFICIAL_CHANNEL_NAME = '官方倍率预设' // 后端 wire 字面量镜像，不做 t()/defaultValue 翻译（见上方注释）
...
export const MODELS_DEV_PRESET_NAME = 'models.dev 价格预设' // 后端 wire 字面量镜像，不做 t()/defaultValue 翻译（见上方注释）
