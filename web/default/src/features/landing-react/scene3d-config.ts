...
export const MODELS: Record<string, any> = {
  openai: { name: 'GPT Series', provider: 'OPENAI', desc: 'Multimodal flagship — top-tier general intelligence and tool use, with the most mature ecosystem.', scene: 'General chat, agents, multimodal understanding and generation.', telemetry: 'Multimodal pipeline online', color: '#ecf3ff' },
  ...
  gemini: { name: 'Gemini Series', provider: 'GOOGLE DEEPMIND', desc: 'Natively multimodal engine with million-token context and strong video/audio understanding.', scene: 'Multimodal analysis, Q&A over very large corpora.', telemetry: '1M token pipeline', color: '#8a7cf8' },
  deepseek: { name: 'DeepSeek Series', provider: 'DEEPSEEK', desc: 'Best value in reasoning and code; open and strong at mathematics.', scene: 'Cost-effective reasoning, code generation, math problem solving.', telemetry: 'Reasoning chain active', color: '#5b78ff' },
  xai: { name: 'Grok Series', provider: 'XAI', desc: 'Plugged into real-time information, with a distinct style and fast-improving reasoning.', scene: 'Real-time information Q&A, trend analysis.', telemetry: 'Real-time retrieval in sync', color: '#f2f6fc' },
  qwen: { name: 'Qwen Series', provider: 'Alibaba Cloud', desc: 'Domestic open-source flagship — strong at code and multilingual tasks, with the broadest size lineup.', scene: 'Chinese conversation, code generation, structured output.', telemetry: 'Full size lineup online', color: '#684eef' },
  ...
  doubao: { name: 'Doubao Large Model', provider: 'ByteDance', desc: 'High concurrency at low cost, great everyday Chinese conversation, proven at scale.', scene: 'Large-scale consumer apps, smart customer service, translation.', telemetry: 'Volcano Engine pipeline', color: '#567beb' },
  kimi: { name: 'Kimi Series', provider: 'Moonshot AI', desc: 'A pioneer of ultra-long context — great for web and document digests, with open-source reasoning models.', scene: 'Long-document reading, research digests, deep reasoning.', telemetry: 'Ultra-long context active', color: '#1783ff' },
  glm_chatglm: { name: 'GLM Series', provider: 'Zhipu AI', desc: 'Tsinghua-rooted technology with strong agent and coding ability; open and accessible.', scene: 'Agent development, coding assistance, academic research.', telemetry: 'Agent pipeline active', color: '#406cfb' },
}
