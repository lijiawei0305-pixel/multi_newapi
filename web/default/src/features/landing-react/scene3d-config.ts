...
export const MODELS: Record<string, any> = {
  ...
  qwen: { name: 'Qwen Series', provider: 'Alibaba Cloud', desc: 'Domestic open-source flagship — strong at code and multilingual tasks, with the broadest size lineup.', scene: 'Chinese conversation, code generation, structured output.', telemetry: 'Full size lineup online', color: '#b98a3f' },
  ...
  doubao: { name: 'Doubao Large Model', provider: 'ByteDance', desc: 'High concurrency at low cost, great everyday Chinese conversation, proven at scale.', scene: 'Large-scale consumer apps, smart customer service, translation.', telemetry: 'Volcano Engine pipeline', color: '#bb756d' },
