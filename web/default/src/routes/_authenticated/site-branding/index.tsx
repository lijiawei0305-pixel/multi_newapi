...
import { SiteBranding } from '@/features/site-branding'

// Agent self-service (site branding): accessible only to the agent owner of the
// current Host's tenant. Non-owners are redirected before the backend rejects
// with AGENT_FORBIDDEN.
export const Route = createFileRoute('/_authenticated/site-branding/')({
