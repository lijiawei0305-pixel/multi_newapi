...
func (r *GeneralOpenAIRequest) GetTokenCountMeta() *types.TokenCountMeta {
	...
	if maxCompletionTokens > maxTokens {
		tokenCountMeta.MaxTokens = common.SaturatingUintToInt(maxCompletionTokens)
	} else {
		tokenCountMeta.MaxTokens = common.SaturatingUintToInt(maxTokens)
	}
...
func (r *OpenAIResponsesRequest) GetTokenCountMeta() *types.TokenCountMeta {
	...
	return &types.TokenCountMeta{
		...
		Files:       fileMeta,
		MaxTokens:   common.SaturatingUintToInt(lo.FromPtrOr(r.MaxOutputTokens, uint(0))),
	}
}
