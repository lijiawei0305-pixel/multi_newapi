...
type Midjourney struct {
	...
	Group                  string  `json:"-" gorm:"type:varchar(50)"`
	ChargedGroupRatio      float64 `json:"-" gorm:"type:decimal(20,8)"`
	BillingSource          string  `json:"-" gorm:"type:varchar(20)"`
	SubscriptionId         int     `json:"-" gorm:"index"`
	SubscriptionResetEpoch int64   `json:"-"`
	SubscriptionOccurredAt int64   `json:"-" gorm:"type:bigint;not null;default:0"`
