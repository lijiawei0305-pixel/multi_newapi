...
**三期(P3 · 品牌营销+国际化续订,2026-07-08 对账,详见 [acceptance.md](../acceptance.md) Part 3)**：≈ **完成一半**——P3-DOM-01 域名/SSL ✅ 超规格(自助绑定+自动签发;剩证书到期监控)；P3-FE-01 营销化 ✅(营销字段全渲染+10 套主题预设)；P3-I18N-01 多语言 ✅(硬编码清零+六语条目全补齐[zh5660/en5581/其余5625],fallback 回归已修;上游拼接键 ~39 记边界)；**P3-RNW-01 续订自动化 ⬜ 未启动**(且微信/支付宝自动扣款需代扣签约资质,外部依赖)；**P3-CUR-01 多币种 ⬜ 未启动**。
